...
<%
	...
	OrderDTO oDTO = (OrderDTO)session.getAttribute("orderDTO");
	System.out.print(oDTO);
	int totalPrice =  oDTO.getgPrice() * oDTO.getgAmount();
%>
<table width="70%" cellspacing="0" cellpadding="0">
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="td_default" height="35"><%=oDTO.getOrderName() %></td>
				</tr>
				<tr>
					<td class="td_default" height="35"> 주소</td>
					<td class="td_default" height="35"> 
						<%=oDTO.getPost() %> <br> <%=oDTO.getAddr1() %> 
					</td>
				</tr>
				
				<tr>
					<td class="td_default" height="35"> 휴대전화</td>
					<td class="td_default" height="35"> <%=oDTO.getPhone() %> </td>
				</tr>
			</table>
	</tr>
		</td>
			...
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					<td height="35" class="td_default">
						<span class="a_default"> <%=oDTO.getgName() %> </span>
					</td>
					<td height="35" class="td_default" align="center">
						<span  id = "price1"> <%=oDTO.getgPrice() %> </span>원
					</td>
					<td height="35" class="td_default" align="center">
						<span id = "num1"> <%=oDTO.getgAmount() %> </span>권
					</td>
					<td height="35" class="td_default" align="center">
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<input type = 'text' id = 'total' value = ' <%=totalPrice %>' readonly>원
					</td>
				</tr>
				<tr>
					<td class="td_default" width="150" height="35"> 결제수단</td>
					<td class="td_default" height="35" align = 'right'> 
					<span> <%=oDTO.getPayMethod() %> </span>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td class="td_default" align="center">
			<a class="a_default" href="OrderListDetailServlet?mem_id=guest">주문조회 페이지로 이동</a></td>
		<td class="td_default" align="center">
			<a class="a_default" href="GoodsCartServlet">주문조회 페이지로 이동</a></td>
	</tr>
	<tr>
		<td height="30">
	</tr>
