---상품
   ...
   ( gCode varchar2(20) PRIMARY KEY, --상품코드
     gCategory varchar2(20) not null, --카테고리
     gName varchar2(50) not null, --상품이름
     gContent varchar2(4000) not null, --상품설명
     gPrice NUMBER(6) not null, --상품가격
     gImage varchar2(20) not null ); --상품이미지
